<script>
  ...
  const onLogout = () => auth.logout() // 아직 미구현
</script>
  ...
  <nav class="main-nav">
	...
	{#if $isLogin}
	  ...
	  <button href="#" class="text-white" on:click={onLogout}>
        ...
        <path d="M20 3h-9c-1.103 0-2 .897-2 2v4h2V5h9v14h-9v-4H9v4c0 1.103.897 2 2 2h9c1.103 0 2-.897 2-2V5c0-1.103-.897-2-2-2z"></path></svg>
	  </button>
	{:else}
		<!--로그인 -->
